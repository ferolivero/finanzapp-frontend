...
export default function Movimientos({ navigation }) {
    ...
    const renderItem = ({ item }) => (<MovRow fecha={dateFormated(item.fecha)} monto={item.monto} categoria={item.categoria} />)
    ...
    return (
        <View style={styles.container}>
            ...
            <Button title="Agregar movimiento" onPress={() => { navigation.navigate('Agregar') }} />
